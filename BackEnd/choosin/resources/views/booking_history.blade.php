    ...
    <div class="uk-container history-title">
      <div class="uk-grid">
        <div class="uk-width-medium-2-3 uk-width-small-3-4 uk-container-center uk-text-left">
          <br><br><p class="hasil-cari-text">Booking History</p>
        </div>
      </div>
    </div>
        ...
        <div class="uk-width-medium-2-3 uk-width-small-3-4 uk-container-center uk-text-left">
          <div class="uk-grid">
            <div class="uk-width-1-1">
              <table border="0" class="uk-table table-history">
                <tbody>
                    <tr>
                        <td>Bungo Palo</td>
                        <td>12/02/2018 18:30</td>
                        <td><a class="booking-history-lihat" href="">Lihat</a></td>
                    </tr>
                    <tr>
                        <td>Bungo Palo</td>
                        <td>12/02/2018 18:30</td>
