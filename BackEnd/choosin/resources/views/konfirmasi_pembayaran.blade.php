          ...
          <div class="uk-grid">
            <div class="uk-width-1-1">
			  <form action="" method="POST" class="fitur-search uk-form uk-search uk-text-center">
				<p class="konfirmasi-title">Konfirmasi Pembayaran</p>
				<p class="konfirmasi-code">58EZAF9897</p>
				<input type="text" name="" class="konfirmasi-input uk-width-1-1 uk-form-large" placeholder="Atas Nama Pengirim">
				<input type="text" name="" class="konfirmasi-input uk-width-1-1 uk-form-large" placeholder="Rekening Tujuan">
				<input type="text" name="" class="konfirmasi-input uk-width-1-1 uk-form-large" placeholder="Waktu">
				<button class="konfirmasi-button uk-button-large uk-button uk-button-danger uk-width-medium-1-4 uk-width-small-1-1" type="submit" name="submit" value="submit" type="button">Konfirmasi</button>
			  </form>
            </div>
          </div>
        </div>
